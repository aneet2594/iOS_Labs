 ...
 */
var steps = 0
func incrementSteps(_ stepsTaken: Int) {
    print(stepsTaken + 100)
}
incrementSteps(9_000)
incrementSteps(9_100)
incrementSteps(9_200)
...
func progressUpdate(goalStepCount: Int = 10_000, _ stepsTaken: Int) {
    if stepsTaken <= ((10 * goalStepCount) / 100) {
        print("You're off to a good start.")
    }
    else if stepsTaken < ((50 * goalStepCount) / 100) {
        print("You're almost halfway there!")
    }
    else if stepsTaken < ((90 * goalStepCount) / 100) {
        print("You're over halfway there!")
    }
    else if stepsTaken < goalStepCount {
