...
var favouriteBook = Book(title: "It Ends With Us", author: "Collen Hover", pages: 237, price: 359.00)
print("Book Details: \nTitle: \(favouriteBook.title)\nAuthor: \(favouriteBook.author)\nPages: \(favouriteBook.pages)\nPrice: \(favouriteBook.price)$\n")
/*:
...
var hp = Laptop(screenSize: 14, repairCount: 2, yearPurchased: 2010)
var dell = Laptop(screenSize: 15, repairCount: 1, yearPurchased: 2020)
/*:
