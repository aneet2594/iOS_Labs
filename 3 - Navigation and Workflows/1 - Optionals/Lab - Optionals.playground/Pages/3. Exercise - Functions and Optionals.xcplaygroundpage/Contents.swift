...
let userAge = "34"
if let returnedAge = checkAge(userAge) {
    print("User age is \(returnedAge)")
} else {
...
let prices = ["Chips": 3.69, "Donuts": 1.89, "Juice": 4.99, "Apple": 0.70, "Banana": 0.53, "Broccoli": 1.99]
let stock = ["Chips": 4, "Donuts": 0, "Juice": 12, "Apple": 6, "Banana": 6, "Broccoli": 3]
...
// Example usage
if let cost = purchase(item: "Donuts") {
    print("The cost is $\(cost)")
} else {
    print("Item is out of stock or doesn't exist.")
}
