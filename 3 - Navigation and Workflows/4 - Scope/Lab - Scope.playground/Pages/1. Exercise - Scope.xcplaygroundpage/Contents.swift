...
print("this happened because the constant foo is only accessible within the scope of the for loop")
...
print("the statements compiled because x is a global scope and is defined and modified within the scope of the for loop. foo is a local scope and is defined and used outside of the loop")
